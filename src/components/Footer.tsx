      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-16">
        ...
        <div className="col-span-2 lg:col-span-1">
          ...
          <div className="flex items-center gap-4">
            <Link href="#" className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors">
        ...
        <div className="col-span-2 lg:col-span-1">
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span className="text-zinc-400">123 Travel Lane, Connaught Place, New Delhi, India 110001</span>
            </li>
            ...
            <li className="flex items-center gap-3">
              ...
              <span className="text-zinc-400">support@trustmetravels.com</span>
            </li>
          </ul>
        </div>
      </div>

      <div className="max-w-7xl mx-auto border-t border-zinc-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-sm text-zinc-500 text-center md:text-left">
          © {new Date().getFullYear()} Trust Me Travels. All rights reserved.
        </p>
        <div className="flex items-center gap-2">
          <p className="text-sm text-zinc-500">Made with ❤️ in India</p>
        </div>
      </div>
    </footer>
  );
